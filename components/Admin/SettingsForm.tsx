      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-card p-6 rounded-xl shadow-sm border border-border">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-muted mb-1">Public Email</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="block text-sm font-medium text-muted mb-1">Physical Address</label>
              <input
                type="text"
                name="address"
        ...
        <div className="bg-card p-6 rounded-xl shadow-sm border border-border md:col-span-2">
          <h2 className="text-xl font-bold text-foreground mb-6">Google Business Profile (Local SEO NAP)</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-muted mb-1">GBP Business Name</label>
              <input
                type="text"
                name="gbpName"
            ...
            <div>
              <label className="block text-sm font-medium text-muted mb-1">GBP Phone</label>
              <input
                type="text"
                name="gbpPhone"
            ...
            <div>
              <label className="block text-sm font-medium text-muted mb-1">GBP Address</label>
              <input
                type="text"
                name="gbpAddress"
            ...
            <div>
              <label className="block text-sm font-medium text-muted mb-1">GBP Website</label>
              <input
                type="text"
                name="gbpWebsite"
        ...
        <div className="bg-card p-6 rounded-xl shadow-sm border border-border md:col-span-2">
          <h2 className="text-xl font-bold text-foreground mb-2">Currency Conversion Rates</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-muted mb-1">USD per 1 GBP</label>
              <input
                type="number"
                step="0.01"
                name="usdPerGbp"
            ...
            <div>
              <label className="block text-sm font-medium text-muted mb-1">BDT per 1 GBP</label>
              <input
                type="number"
                step="0.01"
                name="bdtPerGbp"
        ...
        <div className="bg-card p-6 rounded-xl shadow-sm border border-border md:col-span-2">
          <h2 className="text-xl font-bold text-foreground mb-2">robots.txt</h2>
          <p className="text-sm text-caption mb-4">
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground font-mono text-sm"
          />
        </div>
      </div>

    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Results Summary</label>
            <input
              type="text"
        ...
        <div className="space-y-2">
          ...
          />
          {uploadingGallery && (
            <div className="mt-2 text-sm text-gray-500">Uploading gallery images...</div>
          )}
          {formData.imageGallery.length > 0 && (
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 mt-3">
              {formData.imageGallery.map((url: string) => (
                <div key={url} className="relative group aspect-square rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-700 mt-2 pt-4">
          <div>
            <label htmlFor="isFeatured" className="text-sm font-medium text-gray-900 dark:text-white">
              Show on Home Page
            </label>

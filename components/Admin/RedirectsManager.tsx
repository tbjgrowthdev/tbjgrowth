  ...
  return (
    <div className="space-y-6">
      ...
      <form
        ...
        className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row gap-3 items-end"
      >
        <div className="flex-1 w-full space-y-1">
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400">Source path</label>
          <input
            type="text"
            required
            value={source}
        ...
        <div className="flex-1 w-full space-y-1">
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400">Destination path</label>
          <input
            type="text"
            required
            value={destination}
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent focus:ring-2 focus:ring-blue-500"
          >
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 space-y-3">
        ...
        <textarea
          ...
          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent focus:ring-2 focus:ring-blue-500 font-mono text-sm"
        />
        {importResult && (
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
              ...
              <th className="px-6 py-4 font-medium text-gray-500 dark:text-gray-400">Destination</th>
            ...
            {redirects.length === 0 ? (
              ...
              redirects.map((r) => (
                <tr key={r.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  <td className="px-6 py-4 font-mono text-sm text-gray-900 dark:text-white">{r.source}</td>
                  <td className="px-6 py-4 font-mono text-sm text-gray-500 dark:text-gray-400">{r.destination}</td>
